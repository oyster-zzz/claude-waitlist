...
`;function Oe(e){return a(`status.${e}`)}const Ht=new Set(["pending","ready","waiting_limit","sending","needs_confirm"]);let c,p,q=!1,b="home",k,Ee=!1,E,S,$,J,m,Y=!1,A,D,H,B=!1,U=!1;function oe(e){return e instanceof Error&&/Extension context invalidated/i.test(e.message)}function ie(){U=!0,E&&window.clearInterval(E),S&&window.clearInterval(S),$&&window.clearInterval($),E=void 0,S=void 0,$=void 0}function se(e){if(oe(e)){ie();return}throw e}function Bt(e){if(oe(e)){ie();return}console.error(e)}function f(e){e.catch(Bt)}function Ft(e){return[...e].sort((t,n)=>n.priority!==t.priority?n.priority-t.priority:t.createdAt-n.createdAt)}function le(e){return Ft(e).filter(t=>Ht.has(t.status))}function Ue(e,t,n){const o=Math.max(8,window.innerWidth-t-8),i=Math.max(8,window.innerHeight-n-8);return{left:Math.min(Math.max(8,e.left),o),top:Math.min(Math.max(8,e.top),i)}}function je(){const e=F();return e?`left: ${Math.round(e.left)}px; top: ${Math.round(e.top)}px; right: auto; bottom: auto;`:""}function Re(e=p){return(e==null?void 0:e.querySelector("[data-draggable-panel]"))??void 0}function V(e){return!!(e&&typeof e=="object"&&Number.isFinite(e.left)&&Number.isFinite(e.top))}function F(){return q?A:D}function He(e){q?A=e:D=e}function Be(){const e=Re();if(!e)return F();const t=e.getBoundingClientRect();return{left:t.left,top:t.top}}function _(){H=Be()}async function Fe(){if(!U)try{await chrome.storage.local.set({[Z]:{collapsed:A,expanded:D}})}catch(e){se(e)}}async function Wt(){if(U)return;let e;try{e=(await chrome.storage.local.get(Z))[Z]}catch(t){se(t);return}if(V(e)){A=e,D=e;return}V(e==null?void 0:e.collapsed)&&(A=e.collapsed),V(e==null?void 0:e.expanded)&&(D=e.expanded)}function We(e){const t=Re(e);if(!t)return;const n=t.getBoundingClientRect(),r=H??F(),o=r?Ue(r,n.width,n.height):void 0;if(H=void 0,!o)return;const i=F();(!i||o.left!==i.left||o.top!==i.top)&&(He(o),t.style.left=`${Math.round(o.left)}px`,t.style.top=`${Math.round(o.top)}px`,t.style.right="auto",t.style.bottom="auto",f(Fe()))}function Ke(e){if(!e)return"-";const t=e-Date.now();if(t<=0)return a("time.now");const n=Math.ceil(t/6e4),r=Math.floor(n/60),o=n%60;return r>0?a("time.hours_minutes",{h:r,m:o}):a("time.minutes",{m:o})}function ce(e){return e?new Date(e).toLocaleTimeString([],{hour:"numeric",minute:"2-digit"}):a("time.no_reset")}function Kt(e){if(!e)return a("time.reset_unknown");const t=e-Date.now();if(t<=0)return a("time.already_reset");const n=Math.ceil(t/6e4),r=Math.floor(n/1440),o=Math.floor(n%1440/60),i=n%60;return r>0?a("time.reset_days",{d:r,h:o}):o>0?a("time.reset_hours",{h:o,m:i}):a("time.reset_minutes",{m:i})}function Gt(e){return e===void 0?"-":`${Math.round(e*10)/10}%`}function Ge(e){return e===void 0?"cqr-usage-neutral":e>=85?"cqr-usage-danger":e>=60?"cqr-usage-warn":"cqr-usage-ok"}function de(e){const t=m==null?void 0:m.fiveHour;return t?t.utilization>=100?t.resetsAt?"limited":"limited_unknown_reset":"available":e.claudePage.limitStatus}function Qe(e){var n;if(!e)return;const t=(n=m==null?void 0:m.fiveHour)==null?void 0:n.resetsAt;if(t&&Number.isFinite(t))return t;if(!(e.claudePage.limitStatus!=="limited"&&e.claudePage.limitStatus!=="limited_unknown_reset"))return e.claudePage.resetAt}function Je(e){return e.claudePage.limitStatus==="limited"||e.claudePage.limitStatus==="limited_unknown_reset",a("time.next_reset")}function Ye(e,t){return t||e.claudePage.limitStatus==="limited"||e.claudePage.limitStatus==="limited_unknown_reset"?ce(t):e.claudePage.isOpen?a("time.no_reset"):a("time.detect_after_open")}function Qt(e){const t=de(e);return t==="limited"||t==="limited_unknown_reset"?a("usage.limit_reached"):e.claudePage.isOpen?a(t==="available"?"usage.currently_available":"usage.waiting_detect"):a("usage.open_to_show")}function Jt(e){const t=e.fiveHour;if(t&&!U)if(t.utilization>=100){const n=t.resetsAt&&t.resetsAt>Date.now()?t.resetsAt:void 0;f(P({type:"CONTENT_STATUS",detection:{limitStatus:n?"limited":"limited_unknown_reset",resetAt:n,resetText:n?a("usage.five_hour_100_reset",{time:ce(n)}):a("usage.five_hour_100"),usageText:"usage snapshot: 5-hour 100%",source:"usage",checkedAt:Date.now()}}))}else f(P({type:"CONTENT_STATUS",detection:{limitStatus:"available",usageText:`usage snapshot: 5-hour ${Math.round(t.utilization)}%`,source:"usage",checkedAt:Date.now()}}))}function Yt(e){const t=m==null?void 0:m.fiveHour,n=m==null?void 0:m.weekly;return`
    <div class="flex flex-col gap-3 flex-1 cqr-usage-meters" title="${g(Qt(e))}">
      ${Se(a("usage.five_hour"),t)}
      ${Se(a("usage.weekly"),n)}
    </div>
  `}function Se(e,t){const n=t?Math.max(0,Math.min(100,t.utilization)):0,r=Gt(t==null?void 0:t.utilization);return`
      ...
      <span class="flex items-center gap-3">
        ...
        <span class="flex-1 flex flex-col gap-1 w-full">
          ...
          <span class="w-full h-1.5 bg-border-subtle rounded-full overflow-hidden mb-1" aria-hidden="true">
            <span class="h-full cqr-usage-fill rounded-full transition-all duration-500 ease-out" style="width: ${o}%"></span>
          </span>
  ...
  `}function rn(e){const t=le(e.tasks),n=k?e.tasks.find(l=>l.id===k):void 0,r=de(e),o=e.claudePage.isOpen?Oe(r)??r:a("panel.no_claude_page");return`
  ...
  `}function on(e,t,n,r){const o=Qe(e),i=o?Ke(o):"-";return`
        ...
        <div class="flex justify-between gap-4">
          ...
          <div class="flex flex-col justify-center gap-3 border-l border-border-subtle pl-4 cqr-reset">
            <div class="flex flex-col items-end gap-0.5">
              <span class="font-caption text-caption text-muted-text" data-reset-label>${g(Je(e))}</span>
              <span class="font-timer-display text-timer-display text-ink" data-countdown>${g(i)}</span>
            </div>
            <div class="flex flex-col items-end gap-0.5">
              <span class="font-caption text-caption text-muted-text">${a("panel.reset_time_label")}</span>
              <span class="font-body-md text-body-md text-ink" data-reset-time>${g(Ye(e,o))}</span>
            </div>
          </div>
        </div>
      </section>
  ...
  `:`
    ...
    `}function fe(e){const t=e.mode==="new",n=(c?le(c.tasks).length:0)>=Dt,r=!!e.taskId,o=e.readonlyTitle??(!t&&!r),i=e.title??a(t?"form.new_title":"form.continue_title"),s=e.subtitle??a(t?"form.new_subtitle":"form.continue_subtitle"),l=a(r?"form.title_placeholder_edit":t?"form.title_placeholder_new":"form.title_placeholder_continue"),u=a(r?"form.content_placeholder_edit":"form.content_placeholder"),d=r?160:120;return`
    <form class="cqr-form-view cqr-form ${r?"cqr-edit-form":"cqr-task-form"} flex flex-col h-auto" data-task-form data-conversation-mode="${e.mode}" data-conversation-url="${g(e.conversationUrl??"")}" ${e.taskId?`data-task-id="${g(e.taskId)}"`:""}>
      <div class="flex items-center justify-between px-inner-padding h-12 w-full bg-card-glass backdrop-blur-md border-b border-border-subtle shadow-sm z-10 sticky top-0 shrink-0 cqr-subnav">
        ...
        <div class="flex-1 text-center">
          <h1 class="font-headline-panel text-headline-panel font-bold text-ink">${g(i)}</h1>
        </div>
      ...
      <div class="flex-1 overflow-y-auto p-container-padding flex flex-col gap-stack-lg cqr-form-body">
        ...
        <div class="flex flex-col gap-stack-sm cqr-field-label">
          ...
          <div class="bg-[rgba(255,255,255,0.5)] border border-border-subtle rounded-lg px-3 py-2 flex items-center cqr-input-shell" style="border-radius: 20px;">
            <input class="w-full bg-transparent border-none p-0 text-ink font-body-md text-body-md focus:ring-0 ${o?"opacity-70 cursor-not-allowed":""}" name="conversationTitle" type="text" maxlength="160" value="${g(e.conversationTitle)}" ${o?"readonly":""} placeholder="${g(l)}" />
          </div>
        </div>
        <div class="flex flex-col gap-stack-sm cqr-field-label">
  ...
  `}function cn(){return fe({mode:"current",conversationTitle:Xe(),conversationUrl:Ze()})}function dn(){return fe({mode:"new",conversationTitle:""})}function un(e){return e?fe({mode:e.conversationMode==="new"?"new":"current",conversationTitle:e.conversationTitle??e.title,conversationUrl:e.conversationUrl,content:e.content,priority:e.priority,taskId:e.id,title:a("edit.title"),subtitle:a("edit.subtitle"),primaryLabel:a("form.save"),readonlyTitle:!1}):`
    ...
    <main class="cqr-form-view cqr-form flex flex-col h-auto">
      ...
      <div class="flex-1 overflow-y-auto p-container-padding flex flex-col gap-stack-lg cqr-form-body">
        ...
        <section class="card-glass rounded-xl p-inner-padding flex flex-col gap-3" style="background: rgba(255, 255, 255, 0.5); border: 1px solid rgba(92, 67, 45, 0.16); border-radius: 20px;">
          ...
          <div class="flex flex-col gap-1">
            <span class="font-caption text-caption text-muted-text">${a("settings.github")}: <a class="text-accent-primary hover:underline" href="${Ot}" target="_blank" rel="noopener noreferrer">github.com/oyster-zzz/claude-waitlist-release</a></span>
            <span class="font-caption text-caption text-muted-text">${a("settings.developer")}: <a class="text-accent-primary hover:underline" href="${jt}" target="_blank" rel="noopener noreferrer">${Ut}</a></span>
          </div>
        </section>
      </div>
    </main>
  `}function fn(e){const t=Ve(e.conversationTitle??e.title),n=e.conversationMode==="new";return`
    <div class="queue-item card-glass rounded-lg p-2.5 flex items-center justify-between group transition-colors cqr-task cqr-queue-card" style="border-radius: 20px; position: relative; cursor: pointer;" data-action="edit-task" data-task-id="${g(e.id)}" role="button" tabindex="0" title="${a("task.edit")}">
      <div class="flex items-center gap-2.5 overflow-hidden cqr-task-main">
        <div class="flex flex-col cqr-task-copy">
          <span class="font-title-card text-title-card text-ink cqr-task-title"><span class="cqr-task-title-text">${g(t)}</span>${n?gn():""}</span>
        </div>
      </div>
  ...
  `}function gn(){return`<span class="cqr-new-icon" style="display: inline-flex; margin-left: 12px; color: #2f7d4a; background: transparent; padding: 0; font-size: 10px; font-weight: 800; line-height: 14px; letter-spacing: 0.04em; vertical-align: middle;" title="${a("task.new_label")}" aria-label="${a("task.new_label")}">NEW</span>`}function mn(){const e=(c==null?void 0:c.tasks)??[],t=new Blob([JSON.stringify({tasks:e},null,2)],{type:"application/json"}),n=URL.createObjectURL(t),r=document.createElement("a");r.href=n,r.download=`claude-queue-${new Date().toISOString().slice(0,10)}.json`,r.click(),URL.revokeObjectURL(n)}function bn(e,t){const n=e instanceof Element?e:void 0,r=n==null?void 0:n.closest("button");return r&&r===t&&t.classList.contains("cqr-pill")?!1:!!(n!=null&&n.closest("button, input, textarea, label, select, [data-task-form], .cqr-list, .cqr-task-actions"))}function hn(e){const t=e.querySelector("[data-draggable-panel]");if(!t)return;let n,r=0,o=0,i=0,s=0,l=!1;t.addEventListener("pointerdown",d=>{if(d.button!==0||bn(d.target,t))return;const w=t.getBoundingClientRect();n=d.pointerId,r=d.clientX,o=d.clientY,i=w.left,s=w.top,l=!1,t.setPointerCapture(d.pointerId),t.classList.add("cqr-dragging")}),t.addEventListener("pointermove",d=>{if(n!==d.pointerId)return;const w=d.clientX-r,T=d.clientY-o;if(Math.abs(w)+Math.abs(T)>4&&(l=!0),!l)return;const L=t.getBoundingClientRect(),N=Ue({left:i+w,top:s+T},L.width,L.height);He(N),t.style.left=`${Math.round(N.left)}px`,t.style.top=`${Math.round(N.top)}px`,t.style.right="auto",t.style.bottom="auto",B=!0,d.preventDefault()});const u=d=>{n===d.pointerId&&(n=void 0,t.classList.remove("cqr-dragging"),t.hasPointerCapture(d.pointerId)&&t.releasePointerCapture(d.pointerId),l&&(f(Fe()),window.setTimeout(()=>{B=!1},0)))};t.addEventListener("pointerup",u),t.addEventListener("pointercancel",u)}function xn(e){var n;e.querySelectorAll("[data-action]").forEach(r=>{r.addEventListener("click",o=>{var u;if(B){B=!1,o.preventDefault(),o.stopPropagation();return}o.stopPropagation();const i=o.currentTarget,s=i.dataset.action,l=i.dataset.taskId;if(s==="expand")_(),q=!1,c&&x(c);else if(s==="collapse")tt();else if(s==="show-home")_(),b="home",k=void 0,c&&x(c);else if(s==="show-continue")_(),b="continue",k=void 0,c&&x(c);else if(s==="show-new")_(),b="new",k=void 0,c&&x(c);else if(s==="show-settings")_(),b="settings",k=void 0,c&&x(c);else if(s==="edit-task"&&l)_(),k=l,b="edit",c&&x(c);else if(s==="set-lang"){const d=i.dataset.locale;if(d!=="zh"&&d!=="en")return;const w=d;if(w===vt())return;Ne(w),f(P({type:"UPDATE_SETTINGS",patch:{language:w}})),_(),c&&(c={...c,settings:{...c.settings,language:w}},x(c))}else s==="detect"?(f(ue(!0)),f(v({type:"DETECT_NOW"}))):s==="send"?f(v({type:"SEND_NEXT_NOW"})):s==="test-reset"?f(Zt()):s==="bump"&&l?f(v({type:"BUMP_TASK",taskId:l})):s==="skip"&&l?f(v({type:"SKIP_TASK",taskId:l})):s==="delete"&&l?f(v({type:"DELETE_TASK",taskId:l})):s==="export-queue"?mn():s==="import-queue"?(u=e.querySelector("[data-import-queue-input]"))==null||u.click():s==="clear-active"?f(v({type:"CLEAR_ACTIVE"})):s==="clear-ended"&&f(v({type:"CLEAR_SENT"}))})});const t=e.querySelector("[data-task-form]");t==null||t.addEventListener("submit",r=>{r.preventDefault();const o=new FormData(t),i=String(o.get("content")??"").trim();if(!i)return;const s=r.submitter,l=(s==null?void 0:s.value)==="sendNow",u=t.dataset.conversationMode==="new"?"new":"current",d=String(o.get("conversationTitle")??"").trim()||(u==="new"?a("form.new_claude_conversation"):Xe()),w=u==="current"?t.dataset.conversationUrl||Ze():void 0,T=t.dataset.taskId;_(),b="home",k=void 0,f((async()=>{var ge;if(T){const h=c==null?void 0:c.tasks.find(Q=>Q.id===T),me=(h==null?void 0:h.status)==="needs_confirm"?"ready":h==null?void 0:h.status,be={title:d,content:i,conversationMode:u,conversationTitle:d,conversationUrl:w,priority:Number(o.get("priority"))||0,requireConfirm:l?!1:(h==null?void 0:h.requireConfirm)??!1,autoSend:l||((h==null?void 0:h.autoSend)??(c==null?void 0:c.settings.autoSendNext)??!1),error:void 0,...me?{status:me}:{}},he=await v({type:"UPDATE_TASK",taskId:T,patch:be});if(!he.ok)return;if((s==null?void 0:s.value)!=="saveAndSend"){y(a("toast.task_updated"));return}const ot=((ge=he.state)==null?void 0:ge.tasks.find(Q=>Q.id===T))??(h?{...h,...be}:void 0);await $e(i,ot);return}const L=await v({type:"ADD_TASK",title:d,content:i,conversationMode:u,conversationTitle:d,conversationUrl:w,priority:Number(o.get("priority"))||0,requireConfirm:!1,autoSend:!0});if(!L.ok||!l)return;const N=Xt(L.state??c,i);await $e(i,N)})())}),(n=e.querySelector("[data-import-queue-input]"))==null||n.addEventListener("change",r=>{var s;const o=r.currentTarget,i=(s=o.files)==null?void 0:s[0];i&&f((async()=>{try{const l=JSON.parse(await i.text()),u=Array.isArray(l)?l:l.tasks;if(!Array.isArray(u)){y(a("toast.queue_json_invalid"));return}await v({type:"IMPORT_QUEUE",tasks:u}),y(a("toast.queue_imported"))}catch{y(a("toast.queue_json_invalid"))}finally{o.value=""}})())})}function wn(e){const t=["beforeinput","input","change","keydown","keyup","keypress","compositionstart","compositionupdate","compositionend","paste","cut","copy","pointerdown","pointerup","mousedown","mouseup","click","dblclick","wheel","focusin","focusout"];for(const n of t)e.addEventListener(n,r=>r.stopPropagation())}function vn(){if(Ee||document.getElementById(Ce))return;Ee=!0;const e=document.createElement("div");e.id=Ce,e.setAttribute("data-claude-queue-resumer","true"),Object.assign(e.style,{position:"fixed",inset:"0",width:"0",height:"0",zIndex:"2147483647",pointerEvents:"none"}),(document.body??document.documentElement).append(e),J=e,p=e.attachShadow({mode:"open"}),wn(p),document.addEventListener("pointerdown",t=>{if(q||!J)return;t.composedPath().includes(J)||tt()},!0),f(Wt().then(()=>nt(!0)));try{chrome.storage.onChanged.addListener((t,n)=>{var o;if(n!=="local")return;const r=(o=t[Mt])==null?void 0:o.newValue;r&&!pe()&&x(r)})}catch(t){se(t)}E=window.setInterval(()=>f(K(!1)),15e3),S=window.setInterval(en,3e4),$=window.setInterval(()=>f(ue(!1)),De),window.addEventListener("resize",()=>{p&&We(p)}),window.addEventListener("pagehide",()=>{E&&window.clearInterval(E),S&&window.clearInterval(S),$&&window.clearInterval($)})}const yn=`
...
`;let Pe="",I,ee,te,G=!1;function ne(e){return e instanceof Error&&/Extension context invalidated/i.test(e.message)}function re(){G=!0,at.disconnect(),I!==void 0&&window.clearTimeout(I),te!==void 0&&window.clearTimeout(te),ee!==void 0&&window.clearInterval(ee)}function rt(e){if(!G)try{chrome.runtime.sendMessage(e).catch(t=>{ne(t)&&re()})}catch(t){if(ne(t)){re();return}throw t}}function j(){if(G)return;const e=Le(),t=JSON.stringify({limitStatus:e.limitStatus,resetAt:e.resetAt,resetText:e.resetText,usageText:e.usageText});t!==Pe&&(Pe=t,rt({type:"CONTENT_STATUS",detection:e}))}function _n(){G||(I&&window.clearTimeout(I),I=window.setTimeout(j,350))}const at=new MutationObserver(_n);at.observe(document.documentElement,{childList:!0,subtree:!0,characterData:!0});te=window.setTimeout(j,500);ee=window.setInterval(j,3e4);vn();window.addEventListener("pageshow",()=>{j(),nt(!0).catch(e=>{ne(e)&&re()})});chrome.runtime.onMessage.addListener((e,t,n)=>{if(e.type==="PING")return n({ok:!0}),!1;if(e.type==="DETECT_NOW"){const r=Le();return rt({type:"CONTENT_STATUS",detection:r}),n({ok:!0,detection:r}),!1}return e.type==="SHOW_FLOATING_PANEL"?(tn(),j(),n({ok:!0}),!1):e.type==="SEND_TASK"?(Me(e.content,e.task).then(n).catch(r=>{n({ok:!1,error:r instanceof Error?r.message:String(r)})}),!0):e.type==="WAIT_FOR_CLAUDE_RESPONSE_COMPLETE"?(It().then(()=>n({ok:!0})).catch(r=>{n({ok:!1,error:r instanceof Error?r.message:String(r)})}),!0):!1});
